...
export const industrialEngineer: SEORoadmapPage = {
  slug: 'industrial-engineer',
  title: 'Industrial Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step Industrial Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Industrial Engineer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Industrial Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Industrial Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Industrial Engineer Workflow Automation Project',
    ...
    {
      title: 'Industrial Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['Minitab', 'Arena Simulation', 'Excel', 'Power BI', 'SAP'],
  salaryInfo: {
  ...
  careerOpportunities: ['Industrial Engineer', 'Operations Engineer', 'Quality Engineer'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Industrial Engineer?',
    ...
    {
      question: 'Do I need a degree for Industrial Engineer roles?',
...
export default industrialEngineer;
