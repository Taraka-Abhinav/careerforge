...
export const frontendDeveloper: SEORoadmapPage = {
  slug: 'frontend-developer',
  title: 'Frontend Developer Roadmap (2026)',
  metaDescription: 'Step-by-step Frontend Developer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Build user-facing web experiences with React, TypeScript and modern UI systems.',
    ...
    futureScope: 'Strong demand is expected over the next decade. Common mistake: focusing on frameworks while ignoring HTML, CSS and accessibility. Key tools include React, Next.js, TypeScript, Tailwind CSS, Figma.'
  },
  roadmapSteps: [
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Frontend Developer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Frontend Developer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Frontend Developer Workflow Automation Project',
    ...
    {
      title: 'Frontend Developer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['TypeScript', 'React', 'Next.js', 'Tailwind CSS', 'Vite'],
  salaryInfo: {
  ...
  careerOpportunities: ['Frontend Developer', 'UI Engineer', 'Web Performance Engineer'],
  faqs: [
    {
    ...
    {
      question: 'Do I need a degree for Frontend Developer roles?',
