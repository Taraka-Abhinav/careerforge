...
export const automobileEngineer: SEORoadmapPage = {
  slug: 'automobile-engineer',
  title: 'Automobile Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step Automobile Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Automobile Engineer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Automobile Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Automobile Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Automobile Engineer Workflow Automation Project',
    ...
    {
      title: 'Automobile Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['CATIA', 'MATLAB', 'CANoe', 'ANSYS', 'SolidWorks'],
  salaryInfo: {
  ...
  careerOpportunities: ['Automobile Engineer', 'Vehicle Dynamics Engineer', 'Powertrain Engineer'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Automobile Engineer?',
    ...
    {
      question: 'Do I need a degree for Automobile Engineer roles?',
...
export default automobileEngineer;
