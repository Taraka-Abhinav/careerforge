...
export const chemicalEngineer: SEORoadmapPage = {
  slug: 'chemical-engineer',
  title: 'Chemical Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step Chemical Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Chemical Engineer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Chemical Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Chemical Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Chemical Engineer Workflow Automation Project',
    ...
    {
      title: 'Chemical Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['Aspen HYSYS', 'Aspen Plus', 'MATLAB', 'COMSOL', 'DWSIM'],
  salaryInfo: {
  ...
  careerOpportunities: ['Chemical Engineer', 'Process Engineer', 'Plant Engineer'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Chemical Engineer?',
    ...
    {
      question: 'Do I need a degree for Chemical Engineer roles?',
