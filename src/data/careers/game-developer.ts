...
export const gameDeveloper: SEORoadmapPage = {
  slug: 'game-developer',
  title: 'Game Developer Roadmap (2026)',
  metaDescription: 'Step-by-step Game Developer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Game Developer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Game Developer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Game Developer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Game Developer Workflow Automation Project',
    ...
    {
      title: 'Game Developer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['Unity', 'Unreal Engine', 'C#', 'C++', 'Blender'],
  salaryInfo: {
  ...
  careerOpportunities: ['Game Developer', 'Gameplay Programmer', 'Technical Game Designer'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Game Developer?',
    ...
    {
      question: 'Do I need a degree for Game Developer roles?',
