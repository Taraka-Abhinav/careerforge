...
export const electronicsEngineer: SEORoadmapPage = {
  slug: 'electronics-engineer',
  title: 'Electronics Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step Electronics Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Electronics Engineer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Electronics Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Electronics Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Electronics Engineer Workflow Automation Project',
    ...
    {
      title: 'Electronics Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['Altium Designer', 'LTspice', 'KiCad', 'Oscilloscope', 'Verilog'],
  salaryInfo: {
  ...
  careerOpportunities: ['Electronics Engineer', 'Hardware Engineer', 'PCB Design Engineer'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Electronics Engineer?',
    ...
    {
      question: 'Do I need a degree for Electronics Engineer roles?',
...
export default electronicsEngineer;
