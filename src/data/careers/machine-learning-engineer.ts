...
export const machineLearningEngineer: SEORoadmapPage = {
  slug: 'machine-learning-engineer',
  title: 'Machine Learning Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step Machine Learning Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Machine Learning Engineer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Machine Learning Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Machine Learning Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Machine Learning Engineer Workflow Automation Project',
    ...
    {
      title: 'Machine Learning Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['Python', 'PyTorch', 'MLflow', 'Docker', 'Kubernetes'],
  salaryInfo: {
  ...
  careerOpportunities: ['Machine Learning Engineer', 'Applied Scientist', 'ML Platform Engineer'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Machine Learning Engineer?',
    ...
    {
      question: 'Do I need a degree for Machine Learning Engineer roles?',
