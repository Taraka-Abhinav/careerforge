...
export const aiEngineer: SEORoadmapPage = {
  slug: 'ai-engineer',
  title: 'AI Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step AI Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Build AI products using LLMs, machine learning, MLOps and data pipelines.',
    ...
    futureScope: 'Strong demand is expected over the next decade. Common mistake: learning AI libraries before mastering Python, SQL and statistics. Key tools include Python, PyTorch, Hugging Face, Docker, AWS, Vector Databases.'
  },
  roadmapSteps: [
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for AI Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'AI Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'AI Engineer Workflow Automation Project',
    ...
    {
      title: 'AI Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['Python', 'PyTorch', 'TensorFlow', 'FastAPI', 'Docker'],
  salaryInfo: {
  ...
  careerOpportunities: ['AI Engineer', 'Applied ML Engineer', 'MLOps Engineer'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a AI Engineer?',
    ...
    {
      question: 'Do I need a degree for AI Engineer roles?',
