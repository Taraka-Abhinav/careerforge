...
export const dataScientist: SEORoadmapPage = {
  slug: 'data-scientist',
  title: 'Data Scientist Roadmap (2026)',
  metaDescription: 'Step-by-step Data Scientist roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Data Scientist with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Data Scientist work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Data Scientist Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Data Scientist Workflow Automation Project',
    ...
    {
      title: 'Data Scientist Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['Python', 'Pandas', 'Scikit-learn', 'SQL', 'Jupyter'],
  salaryInfo: {
  ...
  careerOpportunities: ['Data Scientist', 'Analytics Scientist', 'Decision Scientist'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Data Scientist?',
    ...
    {
      question: 'Do I need a degree for Data Scientist roles?',
