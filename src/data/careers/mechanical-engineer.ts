...
export const mechanicalEngineer: SEORoadmapPage = {
  slug: 'mechanical-engineer',
  title: 'Mechanical Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step Mechanical Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Mechanical Engineer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Mechanical Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Mechanical Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Mechanical Engineer Workflow Automation Project',
    ...
    {
      title: 'Mechanical Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['SolidWorks', 'ANSYS', 'AutoCAD', 'MATLAB', 'GD&T'],
  salaryInfo: {
  ...
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Mechanical Engineer?',
    ...
    {
      question: 'Do I need a degree for Mechanical Engineer roles?',
