...
export const devopsEngineer: SEORoadmapPage = {
  slug: 'devops-engineer',
  title: 'DevOps Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step DevOps Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Devops Engineer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for DevOps Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'DevOps Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'DevOps Engineer Workflow Automation Project',
    ...
    {
      title: 'DevOps Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['GitHub Actions', 'Docker', 'Kubernetes', 'Terraform', 'Prometheus'],
  salaryInfo: {
  ...
  careerOpportunities: ['DevOps Engineer', 'SRE', 'Infrastructure Engineer'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a DevOps Engineer?',
    ...
    {
      question: 'Do I need a degree for DevOps Engineer roles?',
