...
export const biomedicalEngineer: SEORoadmapPage = {
  slug: 'biomedical-engineer',
  title: 'Biomedical Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step Biomedical Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Biomedical Engineer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Biomedical Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Biomedical Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Biomedical Engineer Workflow Automation Project',
    ...
    {
      title: 'Biomedical Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['MATLAB', 'LabVIEW', 'SolidWorks', 'Python', 'ImageJ'],
  salaryInfo: {
  ...
  careerOpportunities: ['Biomedical Engineer', 'Medical Device Engineer', 'Clinical Engineer'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Biomedical Engineer?',
    ...
    {
      question: 'Do I need a degree for Biomedical Engineer roles?',
...
export default biomedicalEngineer;
