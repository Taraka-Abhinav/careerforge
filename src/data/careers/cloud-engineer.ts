...
export const cloudEngineer: SEORoadmapPage = {
  slug: 'cloud-engineer',
  title: 'Cloud Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step Cloud Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Cloud Engineer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Cloud Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Cloud Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Cloud Engineer Workflow Automation Project',
    ...
    {
      title: 'Cloud Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['AWS', 'Terraform', 'Docker', 'Kubernetes', 'Linux'],
  salaryInfo: {
  ...
  careerOpportunities: ['Cloud Engineer', 'Site Reliability Engineer', 'Cloud Architect'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Cloud Engineer?',
    ...
    {
      question: 'Do I need a degree for Cloud Engineer roles?',
