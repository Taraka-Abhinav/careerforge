...
export const roboticsEngineer: SEORoadmapPage = {
  slug: 'robotics-engineer',
  title: 'Robotics Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step Robotics Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Robotics Engineer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Robotics Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Robotics Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Robotics Engineer Workflow Automation Project',
    ...
    {
      title: 'Robotics Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['ROS', 'Python', 'C++', 'Gazebo', 'MATLAB'],
  salaryInfo: {
  ...
  careerOpportunities: ['Robotics Engineer', 'Controls Engineer', 'Automation Engineer'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Robotics Engineer?',
    ...
    {
      question: 'Do I need a degree for Robotics Engineer roles?',
...
export default roboticsEngineer;
