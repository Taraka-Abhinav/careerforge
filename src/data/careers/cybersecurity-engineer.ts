...
export const cybersecurityEngineer: SEORoadmapPage = {
  slug: 'cybersecurity-engineer',
  title: 'Cybersecurity Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step Cybersecurity Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Cybersecurity Engineer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Cybersecurity Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Cybersecurity Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Cybersecurity Engineer Workflow Automation Project',
    ...
    {
      title: 'Cybersecurity Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['Linux', 'Wireshark', 'Nmap', 'Burp Suite', 'SIEM'],
  salaryInfo: {
  ...
  careerOpportunities: ['Cybersecurity Engineer', 'Security Analyst', 'Security Architect'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Cybersecurity Engineer?',
    ...
    {
      question: 'Do I need a degree for Cybersecurity Engineer roles?',
