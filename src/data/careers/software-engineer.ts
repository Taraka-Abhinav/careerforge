...
export const softwareEngineer: SEORoadmapPage = {
  slug: 'software-engineer',
  title: 'Software Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step Software Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Software Engineer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Software Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Software Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Software Engineer Workflow Automation Project',
    ...
    {
      title: 'Software Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['TypeScript', 'Node.js', 'PostgreSQL', 'Git', 'Docker'],
  salaryInfo: {
  ...
  careerOpportunities: ['Software Engineer', 'Backend Engineer', 'Platform Engineer'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Software Engineer?',
    ...
    {
      question: 'Do I need a degree for Software Engineer roles?',
