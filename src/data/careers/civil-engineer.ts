...
export const civilEngineer: SEORoadmapPage = {
  slug: 'civil-engineer',
  title: 'Civil Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step Civil Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Civil Engineer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Civil Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Civil Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Civil Engineer Workflow Automation Project',
    ...
    {
      title: 'Civil Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['AutoCAD Civil 3D', 'STAAD.Pro', 'ETABS', 'MS Project', 'Revit'],
  salaryInfo: {
  ...
  careerOpportunities: ['Civil Engineer', 'Structural Engineer', 'Site Engineer'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Civil Engineer?',
    ...
    {
      question: 'Do I need a degree for Civil Engineer roles?',
