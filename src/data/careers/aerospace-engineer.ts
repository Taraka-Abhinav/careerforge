...
export const aerospaceEngineer: SEORoadmapPage = {
  slug: 'aerospace-engineer',
  title: 'Aerospace Engineer Roadmap (2026)',
  metaDescription: 'Step-by-step Aerospace Engineer roadmap with skills, projects, salary insights, tools, and resources to become job-ready in India and globally.',
  introduction: {
    whatIsIt: 'Professional roadmap for becoming a Aerospace Engineer with industry-focused skills and projects.',
  ...
  requiredSkills: [
    { name: 'Core Fundamentals', description: 'Strong base in the principles required for Aerospace Engineer work.', priority: 'high' },
  ...
  projectIdeas: [
    {
      title: 'Aerospace Engineer Starter Project',
      difficulty: 'Beginner',
    ...
    {
      title: 'Aerospace Engineer Workflow Automation Project',
    ...
    {
      title: 'Aerospace Engineer Production-Ready Capstone',
      difficulty: 'Advanced',
  ...
  industryTools: ['CATIA', 'MATLAB', 'ANSYS Fluent', 'Simulink', 'NASTRAN'],
  salaryInfo: {
  ...
  careerOpportunities: ['Aerospace Engineer', 'Flight Systems Engineer', 'Propulsion Engineer'],
  faqs: [
    {
      question: 'How long does it take to become job-ready as a Aerospace Engineer?',
    ...
    {
      question: 'Do I need a degree for Aerospace Engineer roles?',
