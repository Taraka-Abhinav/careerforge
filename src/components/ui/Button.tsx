...
export const Button = ({ variant = 'primary', size = 'md', icon, children, className, ...props }: ButtonProps) => {
  ...
  const sizes = {
    ...
    lg: "px-6.5 py-3 text-[13px] gap-2",
    xl: "px-9 py-4 text-[15px] gap-2.5"
  };
